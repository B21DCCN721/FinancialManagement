...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div
        className="fixed top-32 left-1/4 w-72 h-72 rounded-full pointer-events-none"
        style={{
      ...
      />
      <div
        className="fixed bottom-20 right-1/4 w-64 h-64 rounded-full pointer-events-none"
        style={{
      ...
      <div className="w-full max-w-md relative">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div
              ...
              style={{
                ...
                boxShadow: "0 6px 24px rgba(124, 92, 252, 0.5)",
              }}
            >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              className="flex items-center justify-center gap-2 h-10 rounded-xl text-sm font-medium transition-all hover:scale-105 hover:border-white/20"
              style={{
